...
Ext.override(Shopware.attribute.Form, {
    'registerTypeHandlers': function () {
        ...
        return Ext.Array.insert(handlers, 0, [
            ...
            Ext.create('Shopware.apps.NetiTagsExtensions.view.base.attribute.productStream.field.Handler'),
            Ext.create('Shopware.apps.NetiTagsExtensions.view.base.attribute.customerStream.field.Handler'),
            Ext.create('Shopware.apps.NetiTagsExtensions.view.base.attribute.order.field.Handler')
        ]);
    }
});
//{/block}

...
Ext.define('Shopware.apps.NetiTagsExtensions.view.base.attribute.productStream.field.Handler', {
    ...
    'supports': function (attribute) {
        ...
        if (attribute.get('tableName') !== 's_product_streams_attributes') {
            return false;
        }
    ...
    'create': function (field, attribute) {
        return Ext.apply(field, {
            'xtype': 'neti_tags_product_stream_attribute',
            'flex': 1,

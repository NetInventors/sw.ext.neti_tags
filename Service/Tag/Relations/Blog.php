 ...
 */
class Blog implements RelationsInterface
{
    /**
     * @var string
     */
    ...
    public function searchAssociation($search, $association, $offset, $limit, $id = null, $filter = [], $sort = [])
    {
        ...
        $qbr = $this->modelManager->getRepository(\Shopware\Models\Blog\Blog::class)->createQueryBuilder('t');
    ...
    public function resolveRelations(array $relations)
    {
        ...
        $repository = $this->modelManager->getRepository(\Shopware\Models\Blog\Blog::class);
        ...
        foreach ($relations as $relation) {
            ...
            if (!$model instanceof \Shopware\Models\Blog\Blog) {
                continue;
            }

 ...
 */
class CustomerStream implements RelationsInterface
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    const ENTITY_NAME = 'Shopware\Models\CustomerStream\CustomerStream';
    ...
    {
        $qbr = $this->modelManager->getRepository(\Shopware\Models\CustomerStream\CustomerStream::class)->createQueryBuilder('t');
    ...
    {
        $repository     = $this->modelManager->getRepository(\Shopware\Models\CustomerStream\CustomerStream::class);
